...
* Team members can accumulate and carry up to 80  days of leave -  there is a ‘soft cap’ and ‘hard cap’ on their bank balance. 
    ...
    * Team members are responsible for managing their own leave bank, and will be automatically paid out for anything above the soft cap unless they explicitly request to continue accumulating leave. Team members can set their payout preferences in the `Leave Payout Cap History` tab of the their personal Google Spreadsheet, titled `user-<Github-handle>`. TeamOS will review all balances on or shortly after the last working day of the month, for the payouts to be actioned in the following payroll and the leave balances to be adjusted accordingly.
