...
If you have a UX or feature question please tag the thread by adding a comment with the `#product` tag and a small summary and, preferably, suggested solution(s). Hubot picks these #product-tagged comments up and sends them to the architecture FrontApp inbox, which largely forms our next meeting agenda.
